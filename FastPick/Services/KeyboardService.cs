...
public class KeyboardService
{
    ...
    private void InitializeKeyHandlers()
    {
        ...
        // 方向键：切换图片（TODO: 实现导航）
        // _keyHandlers[VirtualKey.Left] = () => NavigatePrevious();
        // _keyHandlers[VirtualKey.Right] = () => NavigateNext();
    ...
    public void HandleThumbnailClick(Models.PhotoItem clickedItem, bool isCtrlPressed, bool isShiftPressed)
    {
        ...
        {
            // Ctrl+点击：切换选中状态
            _viewModel.SelectItem(clickedItem, !clickedItem.IsSelected);
        }
        else if (isShiftPressed)
        {
            // Shift+点击：连续选择（TODO: 实现）
            _viewModel.SelectItem(clickedItem, true);
        }
        else
        {
            // 普通点击：单选
